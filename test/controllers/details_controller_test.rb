...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference("Detail.count") do
      post details_url, params: { detail: { quanty: @detail.quanty, unit_price: @detail.unit_price } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { quanty: @detail.quanty, unit_price: @detail.unit_price } }
